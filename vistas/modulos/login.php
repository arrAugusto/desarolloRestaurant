...
<html lang="en">
    <head>
        ...
        <!-- MetisMenu CSS -->
        <link href="vistas/css/estilosHome.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="vistas/css/startmin.css" rel="stylesheet">

        <!-- Custom Fonts -->
        <link href="vistas/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body id="bodyImg">
        ...
        <script src="vistas/js/metisMenu.min.js"></script>

        <!-- Custom Theme JavaScript -->
        <script src="vistas/js/startmin.js"></script>
